...
void canvas_update(void *p)
{
    lv_canvas_set_buffer(canvas, p, 320, 320, LV_IMG_CF_TRUE_COLOR);
}
...
int main(void)
{
    ...
    xTaskCreate(lvgl_task, (char *)"lv_task", 512, NULL, configMAX_PRIORITIES - 2, NULL);
